        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700/50 overflow-hidden">
            ...
            {[...Array(3)].map((_, index) => (
              <div key={index} className="p-6">
                <div className="flex items-center">
                  <div className="flex-shrink-0 w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                  <div className="ml-6 flex-1">
                    ...
                    <div className="mt-4 flex items-center">
                      ...
                      <div className="ml-4 h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 animate-pulse"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="p-6 bg-gray-50 dark:bg-gray-700">
            <div className="flex justify-between items-center">
              ...
              <div className="h-12 bg-gray-200 dark:bg-gray-600 rounded w-40 animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
